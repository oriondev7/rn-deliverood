...
export const CartScreen = ({ navigation }: any) => {
  const restaurant: RestaurantModel | undefined = useSelector(selectRestaurant)
  const cartItems: DishModel[] = useSelector(selectCartItems)
  ...
  return (
    <View className="bg-white flex-1">
      ...
      >
        ...
        <View>
          <TouchableOpacity
            onPress={() => navigation.navigate(ScreenName.orderPreparing)}
            style={{ backgroundColor: themeColors.bgColor(1) }}
