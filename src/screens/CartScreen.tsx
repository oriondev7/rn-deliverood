...
export const CartScreen = ({ navigation }: any) => {
  const restaurant: any = useSelector(selectRestaurant)
  ...
  return (
    <View className='bg-white flex-1'>
      ...
      <View className='relative py-4 shadow-sm'>
        ...
        <View>
          <Text className='text-center font-bold text-lg'>You cart</Text>
      ...
      >
        ...
        <View>
          <TouchableOpacity
            onPress={() => navigation.navigate(ScreenName.orderPrepairing)}
            style={{backgroundColor: themeColors.bgColor(1)}}
