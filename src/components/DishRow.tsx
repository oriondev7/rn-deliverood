...
import { addToCart, removeFromCart, selectSameItemsByID } from '../slices/cartSlice'
...
export const DishRow: React.FC<DishRowProps> = ({ dish }) => {
  ...
  const sameItems = useSelector((state: RootState) => selectSameItemsByID(state, dish._id))
